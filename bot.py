...
# ==========================================
TOKEN = "8947203233:AAFT5RS3AFoFwGARfk424pQy8FNgNku0jTw"
...
GLOBAL_BODY_EMOJIS = {
    "➖": "5224274747134607590", "🚫": "6271807757276420702", "😒": "5310175463149151662",
...
firebase_credentials_json = r"""
{
  ...
  "project_id": "akx-number-bot",
  "private_key_id": "50765c978dcfab2efb43614c4ecae809cc3602ae",
  "private_key": "-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n",
  "client_email": "firebase-adminsdk-fbsvc@akx-number-bot.iam.gserviceaccount.com",
  "client_id": "114352160659094085599",
  "auth_uri": "https://accounts.google.com/o/oauth2/auth",
  "token_uri": "https://oauth2.googleapis.com/token",
  "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
  "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-fbsvc%40akx-number-bot.iam.gserviceaccount.com",
...
def main_menu(user_id):
    kb = [
        [
            ...
            {"text": "Search Number", "icon_custom_emoji_id": "5947541849597021813", "style": "primary"}
        ],
        [
            {"text": "Traffic", "icon_custom_emoji_id": "5197503331215361533", "style": "success"}, 
            {"text": "2FA Online", "icon_custom_emoji_id": "5316845444280624802", "style": "primary"}
        ],
        [
            {"text": "Refer", "icon_custom_emoji_id": "6271605395597303365", "style": "success"}, 
...
def menu_design_list_keyboard():
    return {"inline_keyboard": [
        ...
        [{"text": "Edit Get Number", "icon_custom_emoji_id": "6149981675645309107", "callback_data": "md_edit_get_number", "style": "success"},
         {"text": "Edit Search Number", "icon_custom_emoji_id": "5947541849597021813", "callback_data": "md_edit_search_number", "style": "success"}],
        [{"text": "Edit Select Country", "icon_custom_emoji_id": "5336972142066047577", "callback_data": "md_edit_select_country", "style": "primary"}],
        [{"text": "Edit Traffic", "icon_custom_emoji_id": "5197503331215361533", "callback_data": "md_edit_traffic", "style": "primary"},
         {"text": "Edit Refer", "icon_custom_emoji_id": "6271605395597303365", "callback_data": "md_edit_refer", "style": "primary"}],
...
def dxa_control_keyboard():
    ...
    return {"inline_keyboard": [
        ...
        [{"text": f"REFER REWARD: {bot_settings['refer_reward']}", "icon_custom_emoji_id": "6271605395597303365", "callback_data": "dxa_ref_r", "style": "success"},
...
def handle_callback(call):
    ...
    if data == "close_msg":
        ...
        kb.append([{"text": "Back", "icon_custom_emoji_id": "5899797743299205330", "callback_data": "refresh_traffic", "style": "danger"}])
    ...
    # --- Menu Design Integration ---
        ...
        kb = [
            [{"text": "Top Referrers", "icon_custom_emoji_id": "6271605395597303365", "callback_data": "lb_top_refs", "style": "primary"}],
